...
This spritemap only applies to the Dogu15 rig, a seamless rig.
This removes the sprite size offset in the jointsNegateOffsetR15() table, which brings this back to the pre 1.1 version of this script.

User @Int_Illigence and @jonmxl has seen issues with the DoguR15 rig. This spritemap will be included in the next minor release.

https://devforum.roblox.com/t/advanced-classic-clothing-v13-layered4k-texture-rendering-for-classic-clothing-r6-and-r15/3914685/10?u=thenextelectron
]]
